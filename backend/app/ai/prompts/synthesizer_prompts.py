...
6. SCIENTIFIC SAFETY & CLIMATE VOCABULARY:
   - Use observational language: 'risk-relevant signal', 'environmental indicator', 'elevated conditions', 'observed anomaly', 'observational evidence'.
   - Do NOT claim: 'disaster guaranteed', 'predicts a cyclone', or that a storm will occur.
   - Clearly distinguish between direct in-situ observations and regional environmental indicators.
"""
