...
from app.ai.prompts.synthesizer_prompts import RESPONSE_SYNTHESIZER_SYSTEM_PROMPT
...
class DeterministicResponseSynthesizer(BaseResponseSynthesizer):
    ...
    def synthesize(
        ...
        lines.append("Observational evidence highlights vertical stratification and upper ocean heat distribution as risk-relevant signals for regional environmental monitoring.")
